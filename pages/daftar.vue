...
<template>
    <div class="h-screen">
        <div class="h-full w-full flex flex-col items-center p-16">
            <div class="card w-96 border rounded">
                <div class="card-header mb-2 border-b border-gray-400 bg-slate-800 p-4">
                    <h2 class="text-xl font-bold">Login ke Pojokoding</h2>
                </div>
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-primary btn-outline gap-2">Email & Password <i class="bx bxs-key"></i></button>
                    <p></p>
                </div>
            </div>
        </div>
